...
explorer. Every number in that sentence was read from chain state. Across 31 protocol contracts
worth $3.8B, $1.87B sits behind a signer set with zero margin and $1.89B has no timelock at all.
