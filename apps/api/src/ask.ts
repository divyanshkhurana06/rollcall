...
export async function ask(req: Request, res: Response, api: string) {
  ...
  try {
    ...
    send('done', { mode: 'report', safe: resolution.safe, report: r, narrative: b.narrative, context: b.context, resolution, since: b.since, settlement: b.settlement, quote: b.quote, attestation: b.attestation, receipt: b.receipt })
    end()
  } catch (e: any) {
